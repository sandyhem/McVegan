      ...
      <div className="flex flex-row gap-4 justify-center items-center h-screen " style={{
        ...
        <form className="flex flex-col w-[400px] p-8 rounded-2xl bg-white shadow-2xl">
          <h2 className="text-2xl font-bold mb-6 text-center text-slate-700">Register User</h2>
            ...
            <img src={juice} alt=""  className='w-1/3 mx-auto'/> 
          ...
          <button type="submit" onClick={()=>{navigate("/login-user")}} className="cursor-pointer p-3 bg-slate-500 text-white rounded-lg hover:bg-slate-800 transition duration-300">
            Sign In
          </button>

        </form>
        
          <img src={plate} alt="foodie" className="w-[400px] animate-spin"
